...
// const customerRepository: TRepository<Customers> = new CustomerTypeORMRepository()
    ...
    new passportLocal.Strategy(
        ...
        async (username: string, password: string, done: any) => {
            try {
                ...
                const authCustomer = customerToAuthMapper().map<Customers, IAuthCustomer>(customer, 'Customers', 'IAuthCustomer')
